...
acessibilty on the web means designing tools to help those with disabilities (like deaf or blindness) use the intended application

2. Talk about 3 different things you can do to ensure your website is accessible. 

choose colors that those who are color blind can differentiate between.

add alternative text that describe images. 

resize text depending on screen size

3. How would you explain the concept of a variable to someone new to programming?

a variable is a container that holds a valuable that can be changed

4. What is the purpose of using functions in code?

a function takes in inputs, performs a task and relays the ouput of that task
